# ⛓️ ল্যাংচেইন পরিচিতি (LangChain Introduction)
...
┃  📅 চালু: ২০২২ সালে                                   ┃
┃  👨‍💼 তৈরক: Harrison Chase                             ┃
┃  💻 ভাষা: Python, JavaScript, TypeScript              ┃
┃  🔗 উদ্দেশ্য: LLM এর সাথে সহজে কাজ করা               ┃
┃  ★ জনপ্রিয়তা: GitHub তে ৯০K+ তারকা                  ┃
┃  📦 লাইসেন্স: MIT (সম্পূর্ণ ফ্রি)                       ┃
┃                                                      ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
│                                                         │
│  1️⃣  ল্যাংচেইন কী?                                      │
│  2️⃣  কেন ল্যাংচেইন দরকার?                             │
│  3️⃣  মূল উপাদানসমূহ (Components)                        │
│     └─ মডেলস (Models)                                 │
│     └─ প্রম্পট টেমপ্লেট (Prompt Templates)              │
│     └─ চেইনস (Chains)                                 │
│     └─ মেমোরি (Memory)                                 │
│     └─ এজেন্টস (Agents)                               │
│     └─ রিট্রিভাল (Retrieval)                           │
│  4️⃣  বাস্তব প্রয়োগ উদাহরণ                              │
│  5️⃣  ইনস্টলেশন এবং সেটআপ                              │
│  6️⃣  সেরা অনুশীলন                                      │
│                                                         │
│  💡 উদ্দেশ্য: LLM এর শক্তি সহজভাবে ব্যবহার করা          │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
